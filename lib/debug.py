...
appointment_1 = Appointment.create("01/01/2021", "01:00PM", "Checkup", doctor_1.id, patient_1.id)
appointment_2 = Appointment.create("01/02/2021", "02:00PM", "Checkup", doctor_2.id, patient_2.id)
appointment_3 = Appointment.create("01/03/2021", "03:00PM", "Checkup", doctor_3.id, patient_3.id)
appointment_4 = Appointment.create("01/04/2021", "04:00PM", "Checkup", doctor_4.id, patient_4.id)
appointment_5 = Appointment.create("01/05/2021", "05:00PM", "Checkup", doctor_1.id, patient_5.id)
